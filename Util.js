...
const _formatarr = [
    ...
    {format: 'Excel', ext: '.xls', type: 'application', mimetype: 'application/vnd.ms-excel', playable: undefined, downloaable: undefined },
    ...
    {format: 'Powerpoint', ext: '.ppt', type: 'application', mimetype: 'application/vnd.ms-powerpoint', playable: undefined, downloaable: undefined },
    ...
    {format: 'Word Document',  ext: '.docx', type: undefined, mimetype: undefined, playable: undefined, downloadable: undefined },
    {format: undefined, ext: '.3gp', type: 'video', mimetype: 'video/3gpp', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.3gpp', type: 'video', mimetype: 'video/3gpp', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.ai', type: 'application', mimetype: 'application/postscript', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.asf', type: 'video', mimetype: 'video/x-ms-asf', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.asx', type: 'video', mimetype: 'video/x-ms-asf', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.avi', type: 'video', mimetype: 'video/x-msvideo', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.bin', type: 'application', mimetype: 'application/octet-stream', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.bmp', type: 'image', mimetype: 'image/x-ms-bmp', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.cco', type: 'application', mimetype: 'application/x-cocoa', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.crt', type: 'application', mimetype: 'application/x-x509-ca-cert', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.der', type: 'application', mimetype: 'application/x-x509-ca-cert', playable: undefined, downloaable: undefined },
    {format: undefined, ext:'.dll', type: 'application', mimetype: 'application/x-msdos-program', playable: undefined, downloadable: undefined },
    {format: 'Word Document', ext: '.doc', type: 'application', mimetype: 'application/msword', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.ear', type: 'application', mimetype: 'application/java-archive', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.eot', type: 'application', mimetype: 'application/octet-stream', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.eps', type: 'application', mimetype: 'application/postscript', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.flv', type: 'video', mimetype: 'video/x-flv', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.hqx', type: 'application', mimetype: 'application/mac-binhex40', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.htc', type: 'text', mimetype: 'text/x-component', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.ico', type: 'image', mimetype: 'image/x-icon', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.img', type: 'application', mimetype: 'application/octet-stream', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.jad', type: 'text', mimetype: 'text/vnd.sun.j2me.app-descriptor', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.jar', type: 'application', mimetype: 'application/java-archive', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.jardiff', type: 'application', mimetype: 'application/x-java-archive-diff', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.jng', type: 'image', mimetype: 'image/x-jng', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.jnlp', type: 'application', mimetype: 'application/x-java-jnlp-file', playable: undefined, downloaable: undefined },
    ...
    {format: undefined, ext: '.midi', type: 'audio', mimetype: 'audio/midi', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.mml', type: 'text', mimetype: 'text/mathml', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.mng', type: 'video', mimetype: 'video/x-mng', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.mov', type: 'video', mimetype: 'video/quicktime', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.mp3', type: 'audio', mimetype: 'audio/mpeg', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.mpg', type: 'video', mimetype: 'video/mpeg', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.msm', type: 'application', mimetype: 'application/octet-stream', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.msp', type: 'application', mimetype: 'application/octet-stream', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.pdf', type: 'application', mimetype: 'application/pdf', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.pem', type: 'application', mimetype: 'application/x-x509-ca-cert', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.pl', type: 'application', mimetype: 'application/x-perl', playable: undefined, downloaable: undefined },
    {format: undefined, ext:'.pl', type: 'text', mimetype: 'text/x-perl', playable: undefined, downloadable: undefined },
    {format: undefined, ext: '.png', type: 'image', mimetype: 'image/png', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.prc', type: 'application', mimetype: 'application/x-pilot', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.ps', type: 'application', mimetype: 'application/postscript', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.ra', type: 'audio', mimetype: 'audio/x-realaudio', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.rpm', type: 'application', mimetype: 'application/x-redhat-package-manager', playable: undefined, downloaable: undefined },
    {format: undefined, ext:'.rss', type: 'application', mimetype: 'application/rss+xml', playable: undefined, downloadable: undefined },
    {format: undefined, ext: '.rss', type: 'text', mimetype: 'text/xml', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.run', type: 'application', mimetype: 'application/x-makeself', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.sea', type: 'application', mimetype: 'application/x-sea', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.sit', type: 'application', mimetype: 'application/x-stuffit', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.swf', type: 'application', mimetype: 'application/x-shockwave-flash', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.tif', type: 'image', mimetype: 'image/tiff', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.tiff', type: 'image', mimetype: 'image/tiff', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.txt', type: 'text', mimetype: 'text/plain', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.war', type: 'application', mimetype: 'application/java-archive', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.wbmp', type: 'image', mimetype: 'image/vnd.wap.wbmp', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.wml', type: 'text', mimetype: 'text/vnd.wap.wml', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.wmlc', type: 'application', mimetype: 'application/vnd.wap.wmlc', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.wmv', type: 'video', mimetype: 'video/x-ms-wmv', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.xml', type: 'text', mimetype: 'text/xml', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.xpi', type: 'application', mimetype: 'application/x-xpinstall', playable: undefined, downloaable: undefined },
    {format: undefined, ext: '.zip', type: 'application', mimetype: 'application/zip', playable: undefined, downloaable: undefined },
    ...
    {format: undefined, ext: '.atom', type: 'application', mimetype: 'application/atom+xml', playable: undefined, downloaable: undefined },
    ...
    {format: undefined, ext: '.deb', type: 'application', mimetype: 'application/octet-stream', playable: undefined, downloaable: undefined },
    ...
    {format: undefined, ext:'.epub', type: 'application', mimetype: 'application/epub+zip', playable: undefined, downloadable: undefined },
    {format: undefined, ext:'.etx', type: 'text', mimetype: 'text/x-setext', playable: undefined, downloadable: undefined },
    {format: 'Windows Executable', ext: '.exe', type: 'application', mimetype: 'application/octet-stream', playable: undefined, downloaable: undefined },
    ...
    {format: undefined, ext:'.mobi', type: 'application', mimetype: 'application/x-mobipocket-ebook', playable: undefined, downloadable: undefined },
    ...
    {format: undefined, ext: '.pdb', type: 'application', mimetype: 'application/x-pilot', playable: undefined, downloaable: undefined },
    ...
    {format: undefined, ext: '.pm', type: 'application', mimetype: 'application/x-perl', playable: undefined, downloaable: undefined },
    ...
    {format: undefined, ext: '.rar', type: 'application', mimetype: 'application/x-rar-compressed', playable: undefined, downloaable: undefined },
    ...
    {format: undefined, ext: '.tcl', type: 'application', mimetype: 'application/x-tcl', playable: undefined, downloaable: undefined },
    ...
    {format: undefined, ext: '.tk', type: 'application', mimetype: 'application/x-tcl', playable: undefined, downloaable: undefined },
    ...
    {format: undefined, ext: '.xhtml', type: 'application', mimetype: 'application/vnd.wap.xhtml+xml', playable: undefined, downloaable: undefined },
...
const ACUtil = { enforceStringOrArray, fetch_json, formats, gatewayServer, gateway, homeQuery, objectFrom, ObjectDeeperAssign, ObjectFilter, ObjectForEach, ObjectFromEntries, ObjectIndexFrom, parmsFrom, rules, _query, specialidentifiers}; // Needed by archive.html to access gatewayServer
