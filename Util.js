...
const _formatarr = [
  ...
  {format: undefined, ext:'.epub', type: 'application', mimetype: 'application/epub+zip', playable: undefined, downloadable: 'EPUB' },
  ...
  {format: undefined, ext:'.mobi', type: 'application', mimetype: 'application/x-mobipocket-ebook', playable: undefined, downloadable: "KINDLE" },
