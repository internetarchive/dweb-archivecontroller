...
{'custom_rules': {'isbn': 'is_isbn()'},
  ...
  'regex_patterns': {'access-restricted': '^true$',
    ...
    'date': '^([1-2][0-9]{3}-(0[0-9]|1[0-2])-([0-2][0-9]|3[01])|[1-2][0-9]{3}-(0[0-9]|1[0-2])|[1-2][0-9]{3})( '
    '([0-1][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9](\\.[0-9]+)?)?([\\+\\-][0-9][0-9]?(:[0-9][0-9])?)?$',
    'foldoutcount': '^-?[0-9]+$',
    ...
    'publicdate': '^[1-2][0-9]{3}-(0[0-9]|1[0-2])-([0-2][0-9]|3[01])( '
    ...
    'start_localtime': '^[1-2][0-9]{3}-(0[0-9]|1[0-2])-([0-2][0-9]|3[01])( '
    '([0-1][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9](\\.[0-9]+)?)?$',
    'start_time': '^[1-2][0-9]{3}-(0[0-9]|1[0-2])-([0-2][0-9]|3[01])( '
    '([0-1][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9](\\.[0-9]+)?)?$',
    'stop_time': '^[1-2][0-9]{3}-(0[0-9]|1[0-2])-([0-2][0-9]|3[01])( '
    '([0-1][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9](\\.[0-9]+)?)?$',
    'title': '\\s*\\S+',
    'updated': '^[1-2][0-9]{3}-(0[0-9]|1[0-2])-([0-2][0-9]|3[01])$',
    'updatedate': '^[1-2][0-9]{3}-(0[0-9]|1[0-2])-([0-2][0-9]|3[01])( '
    '([0-1][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9](\\.[0-9]+)?)?$',
